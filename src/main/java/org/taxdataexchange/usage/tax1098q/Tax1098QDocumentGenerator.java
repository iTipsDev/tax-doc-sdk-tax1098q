...
import irs.fdxtax641.jsonserializers.Tax1098QSerializer;
import irs.fdxtax641.map2objects.Map2Tax1098Q;
import org.taxdataexchange.core.pdfbuilders.Tax1098QPdfBuilder;
...
public class Tax1098QDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1098Q obj = Map2Tax1098Q.generate( row );
        {
            String asJson = Tax1098QSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1098Q.csv";
        ...
        String outputFileName = "Tax1098Q.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1098QDocumentGenerator generator = new Tax1098QDocumentGenerator( );
